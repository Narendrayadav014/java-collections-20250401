...
public class Application {
	...
	public static void main(String[] args) {
		...
		// filter() is an intermediate operation that uses functional interface Predicate
		// forEach() is a terminal operation that is used to terminate the stream pipeline
		rooms.stream()
